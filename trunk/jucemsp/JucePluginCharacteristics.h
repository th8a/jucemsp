...
*/
#define JucePlugin_Name                     "Juce MSP Plugin"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "A Demo Plugin demonstrating Juce as an MSP Object"

/** The name of your company. (Try to keep this as short as possible)
*/
#define JucePlugin_Manufacturer             "Martin Robinson"

/** A four-character code for your company.
    Use single quotes - this isn't a string!
*/
#define JucePlugin_ManufacturerCode         'MiaJ'
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'Jmsp'
...
/** This allows the plugin to specify the configurations of input/output channels that
    ...
    methods.
*/
#define JucePlugin_PreferredChannelConfigurations   { 1, 1 }, { 2, 2 }, { 4, 4 }
